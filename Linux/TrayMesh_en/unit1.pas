...
begin
  ...
  begin
    ...
    Form1.TrayMeshIcon.BalloonTitle := 'Mesh Agent';
    Form1.TrayMeshIcon.BalloonHint := 'Error restarting service';
    Form1.TrayMeshIcon.BalloonFlags := bfInfo;
    Form1.TrayMeshIcon.ShowBalloonHint;
  end;
  end;
...
begin
  ...
  begin
    Form1.TrayMeshIcon.AnimateInterval := 3000;
    Form1.TrayMeshIcon.BalloonTitle := 'Mesh Agent';
    Form1.TrayMeshIcon.BalloonHint := 'Error starting service';
    Form1.TrayMeshIcon.BalloonFlags := bfInfo;
    Form1.TrayMeshIcon.ShowBalloonHint;
  end;
...
begin
  ...
  begin
    Form1.TrayMeshIcon.AnimateInterval := 200;
    Form1.TrayMeshIcon.BalloonTitle := 'Mesh Agent';
    Form1.TrayMeshIcon.BalloonHint := 'Error stopping service';
    Form1.TrayMeshIcon.BalloonFlags := bfInfo;
    Form1.TrayMeshIcon.ShowBalloonHint;
  end;
end;
