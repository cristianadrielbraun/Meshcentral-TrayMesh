...
begin
  ...
  begin
    ...
    Form1.AgentCheckItem.Caption := 'Agent running';
  ...
  begin
    ...
    Form1.AgentCheckItem.Caption := 'Agent Stopped';
...
begin
  ...
  Form1.ServerCheckItem.Caption := 'Server online';
...
begin
  ...
  Form1.ServerCheckItem.Caption := 'Server offline';
end;

procedure THServidor.ActualizaServidorLocal;
begin
  Form1.ServerCheckItem.ImageIndex := 1;
  Form1.ServerCheckItem.Caption := 'Local Server';
...
begin
  ...
  try
    try
      ...
      begin
        Result := False;
        ShowMessage('Error starting Mesh Agent service. Check your installation');
      end;
      on E: Exception do
      begin
        Result := False;
  ...
  try
    try
      ...
      begin
        ...
        Result := False;
        ShowMessage('Error stopping Mesh Agent service');
      end;
      on E: Exception do
      begin
        Result := False;
...
begin
  try
    ...
    ShowMessage('Error getting address from server. Check the Mesh Agent installation');
    raise;
  end;
  reg.Free;
end;
...
begin
  ...
  begin
    Sleep(500); //workaround porque se pisaban los procesos. Ver como mejorarlo
    if StartService('Mesh Agent') then
    begin
      Form1.TrayMeshIcon.AnimateInterval := 200;
      Form1.TrayMeshIcon.BalloonTitle := 'Mesh Agent';
      Form1.TrayMeshIcon.BalloonHint := 'Service restarted successfully';
...
begin
  ...
  begin
    Form1.TrayMeshIcon.AnimateInterval := 200;
    Form1.TrayMeshIcon.BalloonTitle := 'Mesh Agent';
    Form1.TrayMeshIcon.BalloonHint := 'Service started successfully';
    Form1.TrayMeshIcon.BalloonFlags := bfInfo;
    Form1.TrayMeshIcon.ShowBalloonHint;
  end;
end;
...
begin
  ...
  begin
    Form1.TrayMeshIcon.AnimateInterval := 200;
    Form1.TrayMeshIcon.BalloonTitle := 'Mesh Agent';
    Form1.TrayMeshIcon.BalloonHint := 'Service stopped successfully';
    Form1.TrayMeshIcon.BalloonFlags := bfInfo;
    Form1.TrayMeshIcon.ShowBalloonHint;
  end;
end;
...
begin
    ...
    DialogoSalir.Text:= 'This will NOT stop the Mesh Agent service.';
    DialogoSalir.Title:= 'Exit TrayMesh';
